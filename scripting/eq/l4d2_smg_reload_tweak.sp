...
public OnWeaponReload(Handle:event, String:name[], bool:dontBroadcast)
{
	...
	new Float:oldNextAttack = GetEntPropFloat(weapon, Prop_Send, "m_flNextPrimaryAttack");
	...
	SetEntPropFloat(weapon, Prop_Send, "m_flNextPrimaryAttack", newNextAttack, 0);
	SetEntPropFloat(client, Prop_Send, "m_flNextAttack", newNextAttack, 0);
	SetEntPropFloat(weapon, Prop_Send, "m_flPlaybackRate", playbackRate, 0);
}
